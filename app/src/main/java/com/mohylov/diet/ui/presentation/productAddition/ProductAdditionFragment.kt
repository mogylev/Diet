...
class ProductAdditionFragment :
    BaseFragment<ProductAdditionViewState, ProductAdditionViewActions, ProductAdditionViewModel,
            FragmentProductAdditionBinding>(R.layout.fragment_product_addition) {

    override val binding: FragmentProductAdditionBinding by viewBinding(
    ...
    override val viewModel: ProductAdditionViewModel by viewModels {
        viewModelFactory
    }
    ...
    override fun viewStateChanged(state: ProductAdditionViewState) {
        handleState(state)
    }
